...
describe('test SignUp', () => {
    ...
    it('Confirm Login', (done) => __awaiter(void 0, void 0, void 0, function* () {
        yield request.put('/Auth/signIn').send({ 'email': 'test@test.com', 'password': '123456' })
            .then(res => {
            Data = res;
            done();
        });
...
describe('Test Admin URl', () => {
    let ResponseData;
    it('test Change Statue ', () => __awaiter(void 0, void 0, void 0, function* () {
        yield request.put('/changestatue').set('Token', `'${Data._body.Token}'`).then(res => {
            ResponseData = res;
        });
